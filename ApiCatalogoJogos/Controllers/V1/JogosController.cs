...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /*
         * Nossos serviços (JogoService.cs) consistem em uma CLASSE, dessa forma, para podermos utilizá-los, precisamos criar uma instância da classe.
         * 
         * Não tenho claro o porquê de instanciar a classe JogoService passando-se a Interface (o que constatei é que, fazendo assim,
         * caso uma nova implementação do serviço, como esta que utiliza o postgre como servidor de banco de dados, não esteja herdando
         * da interface, o mesmo não poderá ser instanciado por meio da interface IJogoService, garantindo a integridade da api), mas para isso 
         * 
